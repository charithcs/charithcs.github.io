    ...
    <section id="experience" className="section-padding unified-section-bg">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white drop-shadow-none tracking-tight">
        ...
        <div className="timeline relative max-w-6xl mx-auto">
          ...
          {experienceData.map((item, index) => (
            <div key={index} className="timeline-item relative mb-20 animate-on-scroll">
                  ...
                  <CardContent className="pt-8 pb-8">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-8">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-3">
                          <h3 className="text-2xl lg:text-3xl font-bold text-white">{item.role}</h3>
                    ...
                    <div className="mb-8">
                      <div className="flex items-center gap-2 mb-6">
                        ...
                        <h4 className="text-xl font-semibold text-white">{item.impact.title}</h4>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {item.impact.metrics.map((metric, i) => (
                          <div key={i} className="bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-lg p-4 hover:border-primary/40 transition-colors">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {item.technologies.map(tech => (
                          <TechHoverCard key={tech} tech={tech}>
                            <span
                              className="tech-tag inline-block border border-white bg-white text-black rounded-full px-4 py-2 text-xs font-semibold uppercase tracking-wide transition-all shadow hover:bg-gray-100 hover:scale-105 cursor-pointer"
                              style={{
                                letterSpacing: ".04em",
                    ...
                    {(item.certifications || item.keyProjects) && (
                      <>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          ...
                          {item.keyProjects && (
                            <div>
                              <h5 className="font-semibold text-white mb-2">Key Projects</h5>
                              <ul className="text-sm text-white/80 space-y-1">
