...
const Hero = () => {
  ...
  const metrics = [
    ...
    { icon: Shield, value: "2000+", label: "Threats Mitigated", color: "text-green-400" },    
  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-8 md:mb-12 w-full max-w-4xl">
          {metrics.map((metric, index) => {
            ...
            return (
              <div
                key={index}
                className={`
                  unified-card relative p-3 sm:p-4 md:p-5 rounded-xl transition-all duration-500 transform
                  ${isActive 
