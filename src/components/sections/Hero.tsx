...
const Hero = () => {
  return (
    <section
      ...
      tabIndex={-1}
    >
      <div className="container mx-auto relative z-10 px-6 flex flex-col items-center justify-center h-full pt-20">
        <div className="animate-float">
          <h1
            className="hero-title text-5xl sm:text-6xl md:text-7xl font-extrabold mb-6 leading-tight cursor-pointer outline-none text-center"
            tabIndex={0}
        ...
        <TypeAnimation
          ...
          wrapper="p"
          speed={50}
          className="hero-subtitle text-xl md:text-2xl font-semibold mb-8 animate-subtle-glow text-center"
          repeat={Infinity}
        />
        <p className="max-w-4xl mx-auto text-white/90 mb-12 text-lg leading-relaxed transition-all duration-300 text-center">
